...
pub async fn main(req: Request, env: Env, _ctx: Context) -> Result<Response> {
    ...
    Router::new()
        ...
        .post_async(
            ...
            handlers::auth::verify_turnstile,
        )
        // ── Health ────────────────────────────────────────────────────────
        ...
        // ── Version history ───────────────────────────────────────────────
        .get_async(
            "/api/diary/:diary_id/versions",
            handlers::diary::list_versions,
        )
        .get_async(
            "/api/diary/:diary_id/versions/:version",
            handlers::diary::get_version,
        )
        .delete_async(
            "/api/diary/:diary_id/versions/:version",
            handlers::diary::delete_version,
        )
        // ── Interview + AI ────────────────────────────────────────────────
        ...
        .delete_async(
            ...
            handlers::safety::remove_trigger,
        )
        // ── Sync + erase ──────────────────────────────────────────────────
